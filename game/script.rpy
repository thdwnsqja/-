...
label did_fire:
    ...
    ETC14 "이제 곧 오니가 죽을 것이다. 그것도 네 눈앞에서 목이 떨어져 죽을 것이다.\n그리고 네 은인은 교황이 데려가 이용당하다가 오니처럼 죽고 너도 죽겠지?"
    USER "메...키...아..? 모두... 다... 죽어..?"
    ETC14 "그렇다! 너를 친구라고 불렀던 마왕처럼 저 녀석들도 죽을것이다!!"
    ...
    ETC14 "다시 한번 묻겠다. 힘이 필요한가?"
    USER "나는... 힘이 필요해!! 교황 보다 더 강한 힘을 가지고 싶어!!"
