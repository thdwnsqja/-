...
define config.name = _("journey on this wonder world")
...
define build.name = "journeyonthiswonderworld"
...
define config.save_directory = "journeyonthiswonderworld-1678595785"
